...
_("According to my information") + "\\" + _("have to look at"),
...
farewell = [
_("Now I can return Farewell to my planet.") + "\\" +
_("Thanks for your help!"),
_("My ship is ready.") + "\\" + _("Chau and thanks for helping!"),
_("We did it!") + "\\" + _("I'm Ready to take off.") + "\\" +
_("Until next time!")]

categories = [_("Departments"),  _("Capitals"),  _("Cities"),  _("Waterways"),
              _("Elevations"),  _("Historical Sites")]
...
[_("Department") + '\\' + _("of Tumbes"), 1, _("Tumbes"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Piura"), 1, _("Piura"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Lambayeque"), 1, _("Lambayeque"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of the Libertad"), 1, _("The Libertad"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Cajamarca"), 1, _("Cajamarca"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Amazon"), 1, _("Amazon"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of San Martin"), 1, _("San Martin"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Loreto"), 1, _("Loreto"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Ancash"), 1, _("Ancash"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Huanuco"), 1, _("Huanuco"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Lima"), 1, _("Lima"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Pasco"), 1, _("Pasco"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Junin"), 1, _("Junin"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Ucayali"), 1, _("Ucayali"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Ica"), 1, _("Ica"), _("Come on,  try again")],
[_("Department") + '\\' + _("of Huancavelica"), 1, _("Huancavelica"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Ayacucho"), 1, _("Ayacucho"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Apurimac"), 1, _("Apurimac"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Cusco"), 1, _("Cusco"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of San Martin"), 1, _("San Martin"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Mother of God"), 1, _("Mother of God"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Arequipa"), 1, _("Arequipa"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Puno"), 1, _("Puno"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Moquegua"), 1, _("Moquegua"),
_("Come on,  try again")],
[_("Department") + '\\' + _("of Tacna"), 1, _("Tacna"),
_("Come on,  try again")]]
...
[_("City") + '\\' + _("of Chiclayo"), 2, _("Chiclayo"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Trujillo"), 2, _("Trujillo"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Cajamarca"), 2, _("Cajamarca"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Chachapoyas"), 2, _("Chachapoyas"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Moyobamba"), 2, _("Moyobamba"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Huaraz"), 2, _("Huaraz"), _("Come on,  try again")],
[_("City") + '\\' + _("of Huanuco"), 2, _("Huanuco"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Lima"), 2, _("Lima"), _("Come on,  try again")],
[_("City") + '\\' + _("of Tumbes"), 2, _("Tumbes"), _("Come on,  try again")],
[_("City") + '\\' + _("of Hill of Pasco"), 2, _("Hill of Pasco"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Huancayo"), 2, _("Huancayo"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Pucallpa"), 2, _("Pucallpa"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Ica"), 2, _("Ica"), _("Come on,  try again")],
[_("City") + '\\' + _("of Huancavelica"), 2, _("Huancavelica"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Ayacucho"), 2, _("Ayacucho"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Abancay"), 2, _("Abancay"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Cusco"), 2, _("Cusco"), _("Come on,  try again")],
[_("City") + '\\' + _("of Puerto Maldonado"), 2, _("Puerto Maldonado"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Arequipa"), 2, _("Arequipa"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Puno"), 2, _("Puno"), _("Come on,  try again")],
[_("City") + '\\' + _("of Moquegua"), 2, _("Moquegua"),
_("Come on,  try again")],
...
Questions['Cities'] = [
[_("City") + '\\' + _("of Sullana"), 2, _("Sullana"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Chulucanas"), 2, _("Chulucanas"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Moquegua"), 2, _("Moquegua"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Paita"), 2, _("Paita"), _("Come on,  try again")],
[_("City") + '\\' + _("of Catacaos"), 2, _("Catacaos"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Talara"), 2, _("Talara"), _("Come on,  try again")],
[_("City") + '\\' + _("of Barranca"), 2, _("Barranca"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Huancho"), 2, _("Huancho"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Huaral"), 2, _("Huaral"), _("Come on,  try again")],
[_("City") + '\\' + _("of Chincha"), 2, _("Chincha"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Pisco"), 2, _("Pisco"), _("Come on,  try again")],
[_("City") + '\\' + _("of Tarapoto"), 2, _("Tarapoto"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Juanjui"), 2, _("Juanjui"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Jaen"), 2, _("Jaen"), _("Come on,  try again")],
[_("City") + '\\' + _("of Chimbote"), 2, _("Chimbote"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Juliaca"), 2, _("Juliaca"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Ilo"), 2, _("Ilo"), _("Come on,  try again")],
[_("City") + '\\' + _("of Lambayeque"), 2, _("Lambayeque"),
_("Come on,  try again")],
[_("City") + '\\' + _("of Tingo Maria"), 2, _("Tingo Maria"),
_("Come on,  try again")],
...
[_("River of las Piedras"), 3, _("River of las Piedras"),
_("Come on,  try again")],
[_("River Mother of God"), 3, _("River Mother of God"),
_("Come on,  try again")],
...
Questions["Elevations"] = [[_("The Cordillera Blanca"), 4,
                            _("Cordillera Blanca"), _("Come on,  try again")]]

# Historical sites
dibujoInicial["Historical Sites"] = ["lineasDepto", "capitales", "ciudades"]
nombreInicial["Historical Sites"] = []
Questions["Historical Sites"] = [[_("The city where Jose") + "\\" +
                                  _("San Martin landing"), 2, _("Pisco"),
                                  _("It is in the department") + "\\" +
                                  _("Ica")]]
